...
#[derive(Default, Copy, Clone, BorshSerialize, BorshDeserialize)]
...
impl<V: Default + Copy + Clone + Pod + Zeroable, const NUM_NODES: usize, const MAX_SIZE: usize> Hash
    for Critbit<V, NUM_NODES, MAX_SIZE>
{
...
impl<V: Default + Copy + Clone + Pod + Zeroable, const NUM_NODES: usize, const MAX_SIZE: usize>
    Debug for Critbit<V, NUM_NODES, MAX_SIZE>
{
...
impl<V: Default + Copy + Clone + Pod + Zeroable, const NUM_NODES: usize, const MAX_SIZE: usize> Eq
    for Critbit<V, NUM_NODES, MAX_SIZE>
{
}

impl<V: Default + Copy + Clone + Pod + Zeroable, const NUM_NODES: usize, const MAX_SIZE: usize>
    PartialEq for Critbit<V, NUM_NODES, MAX_SIZE>
{
