...
// };
//
// use byteorder::{ByteOrder, LE, NativeEndian, WriteBytesExt};
// use fehler::throws;
//
...
// #[derive(Clone)]
// pub struct U32Table {
//     dict: Box<[u32; DICTIONARY_SIZE]>,
//     offset: usize,
// }
// impl Default for U32Table {
//     fn default() -> Self {
//         U32Table {
//             dict: Box::new([0; DICTIONARY_SIZE]),
//             offset: 0,
//         }
//     }
// }
...
//         (v << 24).wrapping_mul(889523592379)
//     }
//     #[cfg(target_endian = "big")]
//     fn checksum_u64(v: u64) -> u64 {
//         (v >> 24).wrapping_mul(11400714785074694791)
//     }
...
//             .expect("This code is not supposed to run on a 16-bit arch (let alone smaller)")
...
// #[derive(Clone)]
// pub struct U16Table {
//     dict: Box<[u16; DICTIONARY_SIZE * 2]>, // u16 fits twice as many slots into the same amount of memory
//     offset: usize,
// }
// impl Default for U16Table {
//     fn default() -> Self {
//         U16Table {
//             dict: Box::new([0; DICTIONARY_SIZE * 2]),
//             offset: 0,
//         }
//     }
// }
...
//         // sadly byteorder doesn't have this
