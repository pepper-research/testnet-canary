...
pub struct Runtime<S: Spec> {
    ...
    /// The time module. ++ ++ ++
    pub time: spicenet_time::TimeModule<S>,
    /// Thw capsule module ++ ++ ++
    pub capsule: capsule::Capsule<S>,
    /// The AAOB module ++ ++ ++
    pub aaob: spicenet_aaob::AAOB<S>,
    /// The Risk module ++
    pub risk: spicenet_risk::RiskModule<S>,
    /// The lookup module
    pub lut: lut::LookupTable<S>,
}
